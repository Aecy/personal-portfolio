        ...
        <div className="home__content grid">
          <div className="home__social">
            <motion.a
              ...
              href="https://www.instagram.com/mav_aecy/?hl=fr"
            ...
            <motion.a
              ...
              href="https://www.twitter.com/aecyMV"
              className="home__social-icon"
              target="_blank"
            >
            ...
            <motion.a
              ...
              href="https://www.github.com/Aecy"
              className="home__social-icon"
              target="_blank"
            >
          ...
          <div className="home__data">
            ...
            <p className="home__description">
              Je suis un développeur full-stack avec 8 ans d'expérience.
              J'adore créer des sites & applications. <br/><br/>
              Focus sur l'aspect back (laravel).
            </p>
